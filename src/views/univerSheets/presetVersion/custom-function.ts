    ...
    functionParameter: [
      {
        ...
        detail: "formula.functionList.CUSTOM_ASYNC_OBJECT.functionParameter.value.detail",
        example: "'info'",
        require: 1,
        repeat: 0
      }
    ...
    functionParameter: [
      {
        ...
        detail: "formula.functionList.CUSTOM_ASYNC_ARRAY.functionParameter.value.detail",
        example: "'sheet1'",
        require: 1,
        repeat: 0
      }
