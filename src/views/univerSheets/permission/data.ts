...
export const WORKBOOK_DATA: Partial<IWorkbookData> = {
  id: "o5cNDD",
  sheetOrder: ["fyA2MhlmIxB3VIPHxZ58E"],
  name: "",
  styles: {},
  sheets: {
    fyA2MhlmIxB3VIPHxZ58E: {
      id: "fyA2MhlmIxB3VIPHxZ58E",
      name: "Sheet1",
      tabColor: "",
      hidden: 0,
      rowCount: 1000,
      ...
      // protectedRanges: [
      //   {
      //     id: 'protected-range-1',
      //     unitId: 'o5cNDD',
      //     subUnitId: 'fyA2MhlmIxB3VIPHxZ58E',
      //     name: 'Protected Range 1',
